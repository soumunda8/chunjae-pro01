    ...
    <div class="wrap">
        <div class="contents" id="contents">
            ...
            <section class="page" id="page1">
                <div class="page_wrap">
                    <h2 class="page_tit">자주하는 질문 수정</h2>
                    <br><br><hr><br><br>
                    <form action="updateFaqPro.jsp" method="post">
                        <input type="hidden" value="<%=fno %>" name="fno" id="fno">
                        <table class="tb1">
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="answer" id="answer" class="indata" value="<%=faq.getAnswer() %>" required></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
