                ...
                <form action="updateQnaPro.jsp" method="post">
                    ...
                    <table class="tb1">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" id="name" class="indata" value="<%=qna.getName() %>" readonly>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea rows="10" cols="80" name="content" id="content" maxlength="990" required>
                                    <%=qna.getContent() %>
                                </textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="submit" class="inbtn" value="수정하기">
                            </td>
                        </tr>
                        </tbody>
                    </table>
